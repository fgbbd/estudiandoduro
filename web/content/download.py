...
if __name__ == "__main__":
    input_url = 'https://watchdocumentaries.com/wp-content/uploads/games/traffic-jam-3d/'
    dir_name = 'traffic_jam3d'
    ...
    # build_data('TrafficJam3D-build-4.json', input_url, f'game/{dir_name}/')
